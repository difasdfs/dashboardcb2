...
def query_home_operation():
    ...
    querynya = {
            ...
            [   
                # rekomendasi stok, seminggu lalu, 2 minggu lalu, standar deviasi
                [ "1:00", rekomendasi_stok_hari(q[0].cisitu_1, q[1].cisitu_1), q[0].cisitu_1, q[1].cisitu_1, percantik_float(stat.stdev([q[0].cisitu_1, q[1].cisitu_1])) ],
                [ "2:00", rekomendasi_stok_hari(q[0].cisitu_2, q[1].cisitu_2), q[0].cisitu_2, q[1].cisitu_2, percantik_float(stat.stdev([q[0].cisitu_2, q[1].cisitu_2])) ],
                [ "3:00", rekomendasi_stok_hari(q[0].cisitu_3, q[1].cisitu_3), q[0].cisitu_3, q[1].cisitu_3, percantik_float(stat.stdev([q[0].cisitu_3, q[1].cisitu_3])) ],
                [ "9:00", rekomendasi_stok_hari(q[0].cisitu_9, q[1].cisitu_9), q[0].cisitu_9, q[1].cisitu_9, percantik_float(stat.stdev([q[0].cisitu_9, q[1].cisitu_9])) ],
                [ "10:00", rekomendasi_stok_hari(q[0].cisitu_10, q[1].cisitu_10), q[0].cisitu_10, q[1].cisitu_10, percantik_float(stat.stdev([q[0].cisitu_10, q[1].cisitu_10])) ],
                [ "11:00", rekomendasi_stok_hari(q[0].cisitu_11, q[1].cisitu_11), q[0].cisitu_11, q[1].cisitu_11, percantik_float(stat.stdev([q[0].cisitu_11, q[1].cisitu_11])) ],
                [ "12:00", rekomendasi_stok_hari(q[0].cisitu_12, q[1].cisitu_12), q[0].cisitu_12, q[1].cisitu_12, percantik_float(stat.stdev([q[0].cisitu_12, q[1].cisitu_12])) ],
                [ "13:00", rekomendasi_stok_hari(q[0].cisitu_13, q[1].cisitu_13), q[0].cisitu_13, q[1].cisitu_13, percantik_float(stat.stdev([q[0].cisitu_13, q[1].cisitu_13])) ],
                [ "14:00", rekomendasi_stok_hari(q[0].cisitu_14, q[1].cisitu_14), q[0].cisitu_14, q[1].cisitu_14, percantik_float(stat.stdev([q[0].cisitu_14, q[1].cisitu_14])) ],
                [ "15:00", rekomendasi_stok_hari(q[0].cisitu_15, q[1].cisitu_15), q[0].cisitu_15, q[1].cisitu_15, percantik_float(stat.stdev([q[0].cisitu_15, q[1].cisitu_15])) ],
                [ "16:00", rekomendasi_stok_hari(q[0].cisitu_16, q[1].cisitu_16), q[0].cisitu_16, q[1].cisitu_16, percantik_float(stat.stdev([q[0].cisitu_16, q[1].cisitu_16])) ],
                [ "17:00", rekomendasi_stok_hari(q[0].cisitu_17, q[1].cisitu_17), q[0].cisitu_17, q[1].cisitu_17, percantik_float(stat.stdev([q[0].cisitu_17, q[1].cisitu_17])) ],
                [ "18:00", rekomendasi_stok_hari(q[0].cisitu_18, q[1].cisitu_18), q[0].cisitu_18, q[1].cisitu_18, percantik_float(stat.stdev([q[0].cisitu_18, q[1].cisitu_18])) ],
                [ "19:00", rekomendasi_stok_hari(q[0].cisitu_19, q[1].cisitu_19), q[0].cisitu_19, q[1].cisitu_19, percantik_float(stat.stdev([q[0].cisitu_19, q[1].cisitu_19])) ],
                [ "20:00", rekomendasi_stok_hari(q[0].cisitu_20, q[1].cisitu_20), q[0].cisitu_20, q[1].cisitu_20, percantik_float(stat.stdev([q[0].cisitu_20, q[1].cisitu_20])) ],
                [ "21:00", rekomendasi_stok_hari(q[0].cisitu_21, q[1].cisitu_21), q[0].cisitu_21, q[1].cisitu_21, percantik_float(stat.stdev([q[0].cisitu_21, q[1].cisitu_21])) ],
                [ "22:00", rekomendasi_stok_hari(q[0].unjani_22, q[1].unjani_22), q[0].unjani_22, q[1].unjani_22, percantik_float(stat.stdev([q[0].cisitu_22, q[1].cisitu_22])) ],
                [ "23:00", rekomendasi_stok_hari(q[0].unjani_23, q[1].unjani_23), q[0].unjani_23, q[1].unjani_23, percantik_float(stat.stdev([q[0].cisitu_23, q[1].cisitu_23])) ],
                [ "24:00", rekomendasi_stok_hari(q[0].cisitu_24, q[1].cisitu_24), q[0].cisitu_24, q[1].cisitu_24, percantik_float(stat.stdev([q[0].cisitu_24, q[1].cisitu_24])) ],
            ],
            "Sukajadi" : 
            [   
                # rekomendasi stok, seminggu lalu, 2 minggu lalu, standar deviasi
